...
class Dimens {
  ...
  static final EdgeInsets edgeInsets4_0 = EdgeInsets.symmetric(
    horizontal: four,
  );
  static final EdgeInsets edgeInsets8_0 = EdgeInsets.symmetric(
    horizontal: eight,
  );
  ...
  static final EdgeInsets edgeInsets10_5_10_5 = EdgeInsets.symmetric(
    vertical: five,
    horizontal: ten,
  );

  static final EdgeInsets edgeInsets4_8 = EdgeInsets.symmetric(
    horizontal: four,
    vertical: eight,
  );
  static final EdgeInsets edgeInsets8_4 = EdgeInsets.symmetric(
    horizontal: eight,
    vertical: four,
  );

  static final EdgeInsets edgeInsets12_12_12_0 = EdgeInsets.fromLTRB(
    twelve,
    twelve,
    twelve,
    zero,
  );
  static final EdgeInsets edgeInsets16_10_16_16 = EdgeInsets.fromLTRB(
    sixteen,
    ten,
    sixteen,
    sixteen,
  );
  static final EdgeInsets edgeInsets16_10_16_10 = EdgeInsets.fromLTRB(
    sixteen,
    ten,
    sixteen,
    ten,
  );
  static final EdgeInsets edgeInsets16_5_16_5 = EdgeInsets.fromLTRB(
    sixteen,
    five,
    sixteen,
    five,
  );
  static final EdgeInsets edgeInsets16_0_16_16 = EdgeInsets.fromLTRB(
    sixteen,
    zero,
    sixteen,
    sixteen,
  );
  static final EdgeInsets edgeInsets16_0_16_0 = EdgeInsets.fromLTRB(
    sixteen,
    zero,
    sixteen,
    zero,
  );
  static final EdgeInsets edgeInsets16_16_16_0 = EdgeInsets.fromLTRB(
    sixteen,
    sixteen,
    sixteen,
    zero,
